...
class LiquidityPoolTracker:
    ...
    def get_positions(self, wallet_address: str, position_manager_address: Optional[str] = None,
        ...
        try:
            ...
            print(f"Number of position found: {balance}")
            ...
            for i in range(balance):
                try:
                    ...
                    print(f"Error when fetching position {i}: {e}")
                    continue

            return positions

        except Exception as e:
            print(f"Error when fetching positions: {e}")
            return []
